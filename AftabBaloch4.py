...
__banner__ = """\033[1;91m•~♥~ ?̵̡?̵̨̄?✿(◡‿◡)♥☸~♥~♥~ ?̵̡?̵̨̄?✿(◡‿◡)♥☸~♥~♥~ ?̵̡?̵̨̄?✿
░╦░╔╗╗╗╦═╗░░╔╗╔╦╗╦╔░╔═╗╔╗░ ░╗╗╗╔╔╗╔╗░
░║░║║║║╠╣░░░╚╗║║║║║░╠╣░╚╗░ ░╠╣║║║╗╚╗░
░╩╝╚╝╚╝╩═╝░░╚╝╝╝╝╩╚═╚═╝╚╝░ ░╝╝╚╝╚╝╚╝░
...
print ('                1- E-mail List Maker (1)         ')
print('==============================================')
print ('                2- E-mail List Maker (2)         ')
print('==============================================')
print ('                3- Number List Maker        ')
print('==============================================')
print ('                4- Number Iraq Maker        ')
print('==============================================')
print ('                5- Number Algeria Maker       ')
print('==============================================')
...
if ali1 == '1' :
    ...
    os.system("rm .txt")
    os.system("clear")
    print("                   Author | Aftab Baloch")
    time.sleep(1)
    print('')
    print("               FaceBook | Aftab Baloch")
    time.sleep(1)
    print('')
    print("               WhatsApp | +1 (614) 362-5953")
    time.sleep(1)
    print('')
    print("                     List Maker")
    time.sleep(1)
    ...
    rhaby1 = '1234567890qwertyuiopasdfghjklzxcvbnm'
